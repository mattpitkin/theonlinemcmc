  ...
  <div class="tab-content">
    <div id = "about_tab" class="tab-pane fade in active">
      <div id="about" class="container-top bg-1 text-center"> <!-- changed from container-top -->
        ...
        <h2><a onclick=changeDiv("instructions","id_data_input") data-toggle="pill" href="#instructions">themodel</a> Do you have some data and a model that you want to fit? Well here's the website for you (see <a onclick=changeTab("#caveats") data-toggle="pill" href="#caveats">caveats</a>)!</h2><h3><br>
    ...
    <div id="instructions_top" class="container-fluid bg-1 text-left">
      ...
      <h3 class="text-left" id="id_data_input">Data input</h2>
      <p>
