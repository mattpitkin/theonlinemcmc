...
<!-- Function to change active tabs followed by moving to a set div -->
<script>
function changeDiv(newtab,newdiv){
  changeTab(newtab);
  document.getElementById(newdiv).scrollIntoView(true);
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li class="active"><a data-toggle= "pill" href="#about_tab">ABOUT & EXAMPLES</a></li>
        <li><a data-toggle="pill" href="#input">INPUT</a></li>
        <li><a data-toggle="pill" href="#instructions">INSTRUCTIONS</a></li>
        <li><a data-toggle="pill" href="#caveats">CAVEATS</a></li>
      </ul>
    </div>
  </div>
</nav>
<!--<div class="container-fluid bg-3 text-center">-->
  ...
  <div class="tab-content">
    <div id = "about_tab" class="tab-pane fade in active">
      <div id="about" class="container-top bg-1 text-center"> <!-- changed from container-top -->
        <h2 class="title">THE ONLINE MCMC</h2>
        <h2> Do you have some data and a model that you want to fit? Well this is the website for you! Click <a onclick=changeTab("#input") data-toggle="pill" href="#input">here</a> to get started!</h2><h3><br>
        On this website you can input a model function defined by a set of parameters, including those that you want fit, as well as your data. It will run a statisical sampling algorithm to estimate the posterior probability distributions of those parameters.<br><br>
    ...
    <div id = "input" class="tab-pane fade">
      <div id="input_title" class="container-fluid bg-2">
      ...
      <!-- Allow conditions on parameters e.g. x > y or x < 0 && y > 2 to be set -->
        ...
        <p>
        <div id="id_data_div">
        Input the <a style="color: #BD5D38" href="#id_data_input">data</a>: <span data-toggle="tooltip" title="Input the data that you would like to fit the model to, separated by whitespace or commas." class="glyphicon glyphicon-question-sign"></span>
        <br>
          <div class="col-lg-4">
    ...
    <div class="container-fixed">
        <ul class="nav nav-pills fixed-top-2">
          ...
          <li><a href="#functions">Allowed Functions</a></li>
        </ul>   
      </div>
    <div id="instructions_top" class="container-fluid bg-1 text-left">
      ...
      <div id="id_data_input" class="container-fluid-3 bg-1">
        <h3 class="text-left">Data input</h2>
        <p>
      ...
      <div id="id_likelihood_header" class="container-fluid-3 bg-1">
        <h3 class="text-left" >Likelihood input</h3>
        <p>
      ...
      <div id="sampler_inputs_div" class="container-fluid-2 bg-3 text-center">
      ...
      <div id="functions" class="container-fluid bg-2 text-left">
        ...
        <h3 class="text-left">Trigonometric functions</h3>
          ...
          <ul class="functionlist">
            ...
            <li><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Sine"><span class="describe">Sine</span></a>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.sin.html">sin</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Sine#Inverse">Inverse sine</a></span>: asin <span class="describe">or</span> <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.arcsin.html">arcsin</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Cosine">Cosine</a></span>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.cos.html">cos</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Trigonometric_functions#Inverse_functions">Inverse cosine</a></span>: acos <span class="describe">or</span> <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.arccos.html">arccos</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Trigonometric_functions#Sine.2C_cosine_and_tangent">Tangent</a></span>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.tan.html">tan</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Trigonometric_functions#Inverse_functions">Inverse tangent</a></span>: atan/atan2 <span class="describe">or</span> <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.arctan.html">arctan</a>/<a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.arctan2.html#numpy.arctan2">arctan2</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Hyperbolic_function">Hyperbolic</a> sine</span>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.sinh.html">sinh</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Hyperbolic_function">Inverse hyperbolic</a> sine</span>: asinh <span class="describe">or</span> <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.arcsinh.html">arcsinh</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Hyperbolic_function">Hyperbolic</a> cosine</span>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.cosh.html">cosh</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Hyperbolic_function">Inverse hyperbolic</a>: cosine</span> acosh <span class="describe">or</span> <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.arccosh.html">arccosh</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Hyperbolic_function">Hyperbolic</a> tangent</span>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.tanh.html">tanh</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Hyperbolic_function">Inverse hyperbolic</a> tangent</span>: atanh <span class="describe">or</span> <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.arctanh.html">arctanh</a></li>
          </ul>
        ...
        <h3 class="text-left">Other functions</h3>
          ...
          <ul class="functionlist">
            ...
            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Exponential_function">Exponential function</a> <em>e</em></span>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.exp.html">exp</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Natural_logarithm">Natural logarithm</a> (base <em>e</em>)</span>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.log.html">log</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Common_logarithm">Commom logarithm</a> (base 10)</span>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.log10.html">log10</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Binary_logarithm">Binary logarithm</a> (base 2)</span>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/numpy/reference/generated/numpy.log2.html">log2</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Gamma_function">Gamma function</a></span>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/scipy-0.14.0/reference/generated/scipy.special.gamma.html">gamma</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Error_function">Error function</a></span>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/scipy-0.14.0/reference/generated/scipy.special.erf.html">erf</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Factorial">Factorial "!"</a></span>: <a style="color: #BD5D38" href="http://docs.scipy.org/doc/scipy-0.16.0/reference/generated/scipy.misc.factorial.html">factorial</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Heaviside_step_function">Heavside function </a></span>: <a style="color: #BD5D38" href="https://docs.scipy.org/doc/numpy-1.15.1/reference/generated/numpy.heaviside.html">heaviside</a></li>

            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Piecewise">Piecewise function </a></span>: <a style="color: #BD5D38" href="https://docs.scipy.org/doc/numpy/reference/generated/numpy.piecewise.html">piecewise</a></li>
        ...
        These constants can be input rather than having to give their numerical values.
          ...
          <ul class="functionlist">
            ...
            <li><span class="describe"><a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Pi">&pi;</a></span>: pi</li>

          </ul>
      </div>
    </div>
    <div id ="caveats" class="tab-pane fade in">
      <div id="caveats_title" class="container-fluid bg-2 text-center">
        <h2>CAVEATS</h2>
        <p>
          The sampling algorithms provided are not guaranteed to produce sensible results every time, and your output may contain errors or look odd. Some information and trouble shooting for the samplers can be found <a style="color: #BD5D38" href="https://lscsoft.docs.ligo.org/bilby/samplers.html">here</a>.
        </p>
        <p>
          For very high <a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Signal-to-noise_ratio">SNR</a> models, it is possible for MCMC solutions to converge very slowly as exploring the parameter space becomes difficult. For such cases, solutions will take longer to be produced.
        </p>
        <p>
          If users really want to understand what is being done by this code I would advise learning about <a href="https://en.wikipedia.org/wiki/Bayesian_statistics" style="color: #BD5D38">Bayesian analyses</a> and <a style="color: #BD5D38" href="https://en.wikipedia.org/wiki/Markov_chain_Monte_Carlo">Markov chain Monte Carlo</a> methods. I would also advise learning <a style="color: #BD5D38" href="https://www.python.org/">python</a>, or another programming language, and coding the analysis up themselves, particularly if you have a more complex problem. However, this site aims to be useful starting point.
        </p>
      </div>
    </div>
