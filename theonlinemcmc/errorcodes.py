...
errormessages[PRIOR_INIT_ERR] = "There was a problem initialising the prior values." # Not currently used
errormessages[SAMPLER_INIT_ERR] = "There was a problem initialising the sampler." # Not currently used
